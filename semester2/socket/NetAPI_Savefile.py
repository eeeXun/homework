...
def save_file(fileInfo,target):
    import os,time
    filename=fileInfo[NetAPI.FILE_NAME_TAG]
    filesize=fileInfo[NetAPI.FILE_SIZE_TAG]
    filecontent=fileInfo[NetAPI.FILE_CONTENT_TAG]
    if filename and filesize and filecontent:
